...
ANALYSER_SYSTEM_PROMPT = """You are an AI agent that analyzes the CSV provided by the user. The focus of your analysis should be on what the data is, how it is formatted, what each column stands for, and how new data should be analysed."""

GENERATOR_SYSTEM_PROMPT = """You are an AI agent that generates new CSV rows based on analysis results and sample data. Follow the exact formatting and don't output any extra text. You only ouput formatted data, never any other text."""

ANALYSER_USER_PROMPT = """Analyze the structure and patterns of this sample dataset:
{sample_data}
